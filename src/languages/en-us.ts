...
export const strings = {
  ...
  WISHLIST_PLEDGE_DUPLICATE: 'Item already bought',
  WISHLIST_PLEDGE_ITEM: 'Buy item',
  WISHLIST_PLEDGE_SUCCESS: 'Successfully bought item!',
  WISHLIST_PLEDGE: 'Buy',
  WISHLIST_PLEDGED: pledgedBy => `Bought by ${pledgedBy}`,
  WISHLIST_PLEDGED_GUEST: 'Bought for by a guest user',
  WISHLIST_PLEDGED_ITEM_FOR_USER: user => `Bought item for ${user}.`,
  ...
  WISHLIST_UNPLEDGE_GUARD: 'You did not buy for this', // should never happen unless someone makes their own http requests
  WISHLIST_UNPLEDGE_SUCCESS: 'Successfully un-bought item!',
  WISHLIST_UNPLEDGE: 'Un-buy',
